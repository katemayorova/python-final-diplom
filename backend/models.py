...
class ProductInfo(models.Model):
    name = models.CharField(max_length=80, verbose_name='Название')
    product = models.ForeignKey(Product, verbose_name='Товар', related_name='goods',
                                on_delete=models.CASCADE)
    shop = models.ForeignKey(Shop, verbose_name='Магазин', related_name='goods',
                             on_delete=models.CASCADE)
...
class OrderItem(models.Model):
    ...
    product_info = models.ForeignKey(ProductInfo, verbose_name='Информация о продукте', related_name='products',
                                     blank=True,
                                     on_delete=models.CASCADE)
